...
(define-instruction (mov dest src)
  [(register?  register?)  (instruction (opcode #x89) (modr/m #b11 src dest))]
  [(reference? register?)  (instruction (opcode #x89) (modr/m #b00 src dest))]
  [(register?  reference?)   (instruction (opcode #x8b) (modr/m #b00 dest src))]
